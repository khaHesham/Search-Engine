...
public class Indexer {
	...
	public static void main(String[] args) throws IOException {
		...
		String[] urls = new String[10]; // for testing purposes for now
		...
		String stopWords_PATH = "C:\\Users\\khaled\\Desktop\\indexo\\src\\stopwords.txt";  //will be changed later
		//final String invertedfiles_host = "mongodb+srv://searchengine:mazaritaengine111222333@cluster0.pah6z.mongodb.net/myFirstDatabase?retryWrites=true&w=majority";
		...
		for (String URL : urls) {
			...
			// khaled : Inserting in the Database part
			for (Map.Entry<String, HashMap<String, List<Integer>>> entry1 : invertedIndex.entrySet()) {
				...
				for (Map.Entry<String, List<Integer>> entry : entry1.getValue().entrySet()) {
					tf+=Double.valueOf((Double.valueOf(entry.getValue().size())/Double.valueOf(doc_size))*((Double)importance.get(entry.getKey())/10.0));
				}
